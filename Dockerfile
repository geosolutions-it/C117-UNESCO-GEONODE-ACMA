...
COPY src /usr/src/acma/
WORKDIR /usr/src/acma
...
RUN chmod +x /usr/src/acma/tasks.py \
    && chmod +x /usr/src/acma/entrypoint.sh
...
# ENTRYPOINT /usr/src/acma/entrypoint.sh
